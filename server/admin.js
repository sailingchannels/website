...
module.exports = {
	...
	deleteBlacklisted: function(req, res) {
		...
		isAdmin(me._id, function(admin) {
			...
			global.blacklist.remove({"_id": req.params.id}, function(err, result) {
	...
	deleteAdditional: function(req, res) {
		...
		isAdmin(me._id, function(admin) {
			...
			// actually delete item from mongodb
			global.additional.remove({"_id": req.params.id}, function(err, result) {
	...
	deleteFlags: function(req, res) {
		...
		isAdmin(me._id, function(admin) {
			...
			// actually delete item from mongodb
			global.flags.remove({"_id.channel": req.params.channel, "_id.user": req.params.user}, function(err, result) {
