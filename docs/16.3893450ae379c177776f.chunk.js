webpackJsonp([16], {
	"./app/components/Description/index.js": function(e, t, a) {
		"use strict";
		function n(e, t) {
		...
		var s = a("./node_modules/react/index.js"),
			i = a.n(s),
			l = a("./node_modules/anchorme/dist-node/index.js"),
			c = a.n(l),
			u = (function() {
				var e =
					...
					d(t, [
						{
							...
							value: function(e, t) {
								...
								var a = t.substr(0, e);
								return /^\S/.test(t.substr(e)) ? a.replace(/\s+\S*$/, "") : a;
							}
						},
						{
							key: "toggleMore",
	...
	"./node_modules/anchorme/dist-node/index.js": function(e, t, a) {
		...
		var n = a("./node_modules/anchorme/dist-node/util.js"),
			...
			r = a("./node_modules/anchorme/dist-node/tests/ip.js"),
			s = a("./node_modules/anchorme/dist-node/tests/url.js"),
			i = a("./node_modules/anchorme/dist-node/transform/transform.js"),
			l = a("./node_modules/anchorme/dist-node/tests/hasprotocol.js"),
			c = function(e, t) {
				return (t = n.defaultOptions(t)), i.default(e, t);
			};
		(c.validate = {
			ip: r.default,
			url: function(e) {
				var t = l.default(e) || "";
				return (e = e.substr(t.length)), (e = encodeURI(e)), s.default(e);
			},
			email: o.default
		}),
			(t.default = c);
	...
	"./node_modules/anchorme/dist-node/separate/separate.js": function(e, t, a) {
		...
		Object.defineProperty(t, "__esModule", { value: !0 });
		var r = a("./node_modules/anchorme/dist-node/separate/fix.js");
	...
	"./node_modules/anchorme/dist-node/tests/email.js": function(e, t, a) {
		...
		function n(e) {
			var t = e.match(r);
			if (null === t) return !1;
			for (var a = s.length - 1; a >= 0; a--) if (s[a].test(e)) return !1;
			var n = t[2];
	...
	"./node_modules/anchorme/dist-node/tests/url.js": function(e, t, a) {
		...
		function n(e) {
			...
			return (
				null !== t &&
				("string" == typeof t[3] &&
					(-1 !== r.tlds.indexOf(t[3].toLowerCase()) && !(t[5] && !o.isPort(t[5]))))
			);
		}
		Object.defineProperty(t, "__esModule", { value: !0 });
		var o = a("./node_modules/anchorme/dist-node/util.js"),
			r = a("./node_modules/anchorme/dist-node/lists.js"),
			s = /^(https?:\/\/|ftps?:\/\/)?([a-z0-9%\-]+\.){1,}([a-z0-9\-]+)?(:(\d{1,5}))?(\/([a-z0-9\-._~:\/\?#\[\]@!$&'\(\)\*\+,;=%]+)?)?$/i;
		t.default = n;
	},
	"./node_modules/anchorme/dist-node/transform/identify.js": function(e, t, a) {
		...
		function n(e, t) {
			return e.map(function(a, n) {
				var c = encodeURI(a);
				if (c.indexOf(".") < 1 && !r.default(c)) return a;
				var u = null,
					d = r.default(c) || "";
				return (
					...
					t.files &&
						"file:///" === d &&
						c.split(/\/|\\/).length - 1 &&
						(u = { reason: "file", protocol: d, raw: a, encoded: c }),
					!u &&
						t.urls &&
						l.default(c) &&
						(u = {
					...
					!u &&
						t.emails &&
						o.default(c) &&
						(u = { reason: "email", protocol: "mailto:", raw: a, encoded: c }),
					!u &&
						t.ips &&
						i.default(c) &&
						(u = {
					...
					u && (("'" !== e[n - 1] && '"' !== e[n - 1]) || !~s.htmlAttrs.indexOf(e[n - 2]))
						? u
						: a
				);
			});
		...
		var o = a("./node_modules/anchorme/dist-node/tests/email.js"),
			r = a("./node_modules/anchorme/dist-node/tests/hasprotocol.js"),
			s = a("./node_modules/anchorme/dist-node/lists.js"),
	...
	"./node_modules/anchorme/dist-node/transform/transform.js": function(e, t, a) {
		...
		Object.defineProperty(t, "__esModule", { value: !0 });
		var r = a("./node_modules/anchorme/dist-node/separate/separate.js"),
			s = a("./node_modules/anchorme/dist-node/transform/identify.js"),
			i = a("./node_modules/anchorme/dist-node/separate/separate.js");
		t.default = n;
	},
