				...
				<div className="row content-row">
					...
					<div className="col-md-6">
						...
						<p>
							...
							itself or through third parties, there are: Cookie and Usage data. Other
							Personal Data collected may be described in other sections of this
						...
						<p>
							...
							purposes indicated. In addition to the Data Controller, in some cases,
						...
						<p>
							...
							its services, as well as for the following purposes: Analytics and
							Displaying content from external platforms. The Personal Data used for
							each purpose is outlined in the specific sections of this document.
						</p>
						<center>
							<p>~</p>
						</center>
						...
						<p>
							...
							directly from the pages of this Application and interact with them. If a
							service of this kind is installed, it may still collect web traffic data
							for the pages where the service is installed, even when users do not use
							it.
						</p>
						<center>
							<p>~</p>
						...
						<p>
							...
							pages. Personal Data collected: Cookie and Usage data. Place of
							processing: USA –{" "}
							<a
						...
						<p>
							...
							by Directive 2009/136/EC, on the subject of Cookies. This privacy policy
							relates solely to this Application.
						</p>
					</div>
					<div className="col-md-3" />
				</div>
