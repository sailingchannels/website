					...
					<div className="col-md-10">
						...
						<div className="row">
							...
							<div className="col-md-3 col-sm-3">
								<p><b>Views:</b> {(this.state.video.views || 0).toLocaleString()}</p>
								<p><b>Likes:</b> <i className="fa fa-thumbs-up fa-fw"></i> {(this.state.video.likes || 0).toLocaleString()} <i className="fa fa-thumbs-down fa-fw"></i> {(this.state.video.dislikes || 0).toLocaleString()}</p>
