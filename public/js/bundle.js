    ...
    _createClass(LanguageActions, [{
        ...
        value: function getLanguages() {
            ...
            $.ajax({
                ...
                _this.actions.getLanguagesFail(jqXhr);
            });
        }
    }]);
...
},{"../actions/ChannelActions":1,"../stores/ChannelStore":27,"./Logo":17,"./OffsetMenu":18,"react":"react"}],7:[function(require,module,exports){
"use strict";
...
var ChannelList = (function (_React$Component) {
	...
	_createClass(ChannelList, [{
		...
		value: function scrollWindow() {
			...
			if ($(window).scrollTop() + $(window).height() > $(document).height() - scrollBottomThreshold && this.state.loading === false) {
				this.setState({
					"loading": true
				});
...
},{"../actions/ChannelActions":1,"../stores/ChannelStore":27,"./ChannelListItem":8,"react":"react","react-router":"react-router"}],8:[function(require,module,exports){
"use strict";
			...
			return _react2["default"].createElement(
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(
						"center",
						null,
						_react2["default"].createElement("img", { src: "https://cdn.rawgit.com/thomasbrueggemann/sailing-channels/master/public/img/spacer.png", "data-src": this.props.channel.thumbnail, className: "channel-thumb" })
					)
				),
				_react2["default"].createElement(
					"div",
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(
						"a",
						{ target: "_blank", href: "https://youtube.com/channel/" + this.props.channel.id + "?sub_confirmation=1", className: "btn btn-danger btn-sidebar btn-raised" },
						_react2["default"].createElement("i", { className: "fa fa-youtube-play" }),
						" Subscribe"
					)
				)
...
},{"../actions/LanguageActions":2,"../stores/LanguageStore":28,"react":"react"}],17:[function(require,module,exports){
"use strict";
...
},{"../actions/ChannelActions":1,"../stores/ChannelStore":27,"./ChannelListItem":8,"./VideoListItem":24,"react":"react"}],24:[function(require,module,exports){
"use strict";
...
var VideoListItem = (function (_React$Component) {
	...
	function VideoListItem(props) {
		...
		_get(Object.getPrototypeOf(VideoListItem.prototype), "constructor", this).call(this, props);
		this.state = {
			"showVideo": false
		};
	}
			...
			return _react2["default"].createElement(
				...
				_react2["default"].createElement(
					...
					_react2["default"].createElement(
						"center",
						null,
						_react2["default"].createElement("img", { src: "https://cdn.rawgit.com/thomasbrueggemann/sailing-channels/master/public/img/spacer.png", "data-src": "http://img.youtube.com/vi/" + this.props.video._id + "/default.jpg", className: "channel-thumb" })
					)
				),
				_react2["default"].createElement(
					"div",
					...
					_react2["default"].createElement(
						...
						_react2["default"].createElement(
							"a",
							{ href: "javascript:void(0);", onClick: this.toggleShowVideo.bind(this) },
							this.props.video.title
						)
					),
					_react2["default"].createElement(_Description2["default"], { text: this.props.video.description, video: true }),
					this.state.showVideo === true ? _react2["default"].createElement("iframe", { className: "inline-video", width: "100%", height: "315", src: "https://www.youtube.com/embed/" + this.props.video._id, frameBorder: "0", allowFullScreen: true }) : null
				),
				_react2["default"].createElement(
					"div",
					{ className: "col-md-3 col-xs-10 col-xs-offset-2 col-md-offset-0" },
					...
					_react2["default"].createElement(
						"a",
						{ href: "javascript:void(0);", onClick: this.toggleShowVideo.bind(this), className: "btn btn-default btn-sidebar btn-raised" },
						_react2["default"].createElement("i", { className: "fa fa-youtube-play" }),
						" Watch video"
					)
				)
...
},{"./Description":12,"react":"react","react-router":"react-router"}],25:[function(require,module,exports){
"use strict";
...
},{"./routes":26,"history/lib/createBrowserHistory":35,"react":"react","react-dom":"react-dom","react-router":"react-router"}],26:[function(require,module,exports){
"use strict";
...
},{"./components/App":4,"./components/ChannelDetail":6,"./components/ChannelMissing":9,"./components/Contributions":10,"./components/DataCollection":11,"./components/Home":14,"./components/Impressum":15,"./components/PrivacyPolicy":20,"./components/SearchResult":22,"react":"react","react-router":"react-router"}],27:[function(require,module,exports){
"use strict";
...
},{"../actions/ChannelActions":1,"../alt":3}],28:[function(require,module,exports){
"use strict";
...
var LanguageStore = (function () {
	...
	_createClass(LanguageStore, [{
		...
		value: function getLanguagesFail(jqXhr) {
...
},{"../actions/LanguageActions":2,"../alt":3}],29:[function(require,module,exports){
...
},{"_process":29,"warning":47}],33:[function(require,module,exports){
'use strict';
...
},{"./Actions":30,"./DOMStateStorage":32,"./DOMUtils":33,"./ExecutionEnvironment":34,"./createDOMHistory":36,"./parsePath":41,"_process":29,"invariant":46}],36:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./DOMUtils":33,"./ExecutionEnvironment":34,"./createHistory":37,"_process":29,"invariant":46}],37:[function(require,module,exports){
...
module.exports = exports['default'];
},{"./Actions":30,"./AsyncUtils":31,"./createLocation":38,"./deprecate":39,"./parsePath":41,"./runTransitionHook":42,"deep-equal":43}],38:[function(require,module,exports){
//import warning from 'warning'
'use strict';
...
},{"./extractPath":40,"_process":29,"warning":47}],42:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":29,"warning":47}],43:[function(require,module,exports){
